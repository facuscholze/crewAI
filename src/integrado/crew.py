...
from .tools.messenger_tool import MessengerTool
from .tools.runtime_context import set_current_session, reset_current_session
...
from .tools.gmail_imap_tool import (
    GmailIMAPTool,
    GmailIMAPSearchTool,
    GmailIMAPAutoReplyTool,
    GmailIMAPWebhookTool,
)
from .tools.calendar_service_account import (
    CalendarTool,
    CalendarUpdateTool,
    CalendarSearchTool,
)
...
from .tools.conversation_context_tool import (
...
class Integrado(object):
    ...
    def _load_full_knowledge(self) -> str:
        ...
        knowledge_dir = os.path.normpath(
            os.path.join(module_dir, '..', '..', 'knowledge')
        )
        chunks = []
    ...
    def whatsapp_agent(self) -> Agent:
        return Agent(
            ...
            tools=[
                ...
                RagRetrieverTool(),
                *(
                    [ElevenLabsVoiceTool(), ElevenLabsCallTool()]
    ...
    def process_omnicanal_message(
        self,
        channel: str,
        user_id: str,
        message: str,
        message_type: str = "text",
        original_message_id: str = None,  # type: ignore
    ):
        ...
        inputs = {
            ...
            'human_escalation_number': os.getenv('HUMAN_ESCALATION_NUMBER', '+543755629953'),  # Número de la clínica para escalamientos
        }
    ...
    def schedule_calendar_event(self, user_id: str, event_details: dict):
        ...
        try:
            crew = Crew(
                agents=[self.calendar_agent(), self.coordinator()],  # type: ignore
